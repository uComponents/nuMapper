...
namespace nuMapper.Property
{
    ...
    public abstract class PropertyMapperBase
    {
        ...
        private readonly static MethodInfo _getNodePropertyMethod = typeof(PublishedContentExtensions).GetMethods().First(m => m.Name == "GetPropertyValue" && m.IsGenericMethod);
